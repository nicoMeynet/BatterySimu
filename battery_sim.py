...
print("Filling missing timestamps in solar production with an average value between the values before and after the missing timestamp")
...
print("Filling missing timestamps in phase A with an average value between the values before and after the missing timestamp")
...
print("Filling missing timestamps in phase B with an average value between the values before and after the missing timestamp")
...
print("Filling missing timestamps in phase C with an average value between the values before and after the missing timestamp")
...
data_injected = [
    ["Phase A Injected Off-Peak", current_injected_energy_Wh['phase_a']['HC'], simulated_injected_energy_Wh['phase_a']['HC'], simulated_injected_energy_Wh['phase_a']['HC'] - current_injected_energy_Wh['phase_a']['HC'], get_current_tariff_price("HC", "inject") * abs(simulated_injected_energy_Wh['phase_a']['HC'] - current_injected_energy_Wh['phase_a']['HC']) / 1000],
    ["Phase A Injected Peak", current_injected_energy_Wh['phase_a']['HP'], simulated_injected_energy_Wh['phase_a']['HP'], simulated_injected_energy_Wh['phase_a']['HP'] - current_injected_energy_Wh['phase_a']['HP'], get_current_tariff_price("HP", "inject") * abs(simulated_injected_energy_Wh['phase_a']['HP'] - current_injected_energy_Wh['phase_a']['HP']) / 1000],
    ["Phase B Injected Off-Peak", current_injected_energy_Wh['phase_b']['HC'], simulated_injected_energy_Wh['phase_b']['HC'], simulated_injected_energy_Wh['phase_b']['HC'] - current_injected_energy_Wh['phase_b']['HC'], get_current_tariff_price("HC", "inject") * abs(simulated_injected_energy_Wh['phase_b']['HC'] - current_injected_energy_Wh['phase_b']['HC']) / 1000],
    ["Phase B Injected Peak", current_injected_energy_Wh['phase_b']['HP'], simulated_injected_energy_Wh['phase_b']['HP'], simulated_injected_energy_Wh['phase_b']['HP'] - current_injected_energy_Wh['phase_b']['HP'], get_current_tariff_price("HP", "inject") * abs(simulated_injected_energy_Wh['phase_b']['HP'] - current_injected_energy_Wh['phase_b']['HP']) / 1000],
    ["Phase C Injected Off-Peak", current_injected_energy_Wh['phase_c']['HC'], simulated_injected_energy_Wh['phase_c']['HC'], simulated_injected_energy_Wh['phase_c']['HC'] - current_injected_energy_Wh['phase_c']['HC'], get_current_tariff_price("HC", "inject") * abs(simulated_injected_energy_Wh['phase_c']['HC'] - current_injected_energy_Wh['phase_c']['HC']) / 1000],
    ["Phase C Injected Peak", current_injected_energy_Wh['phase_c']['HP'], simulated_injected_energy_Wh['phase_c']['HP'], simulated_injected_energy_Wh['phase_c']['HP'] - current_injected_energy_Wh['phase_c']['HP'], get_current_tariff_price("HP", "inject") * abs(simulated_injected_energy_Wh['phase_c']['HP'] - current_injected_energy_Wh['phase_c']['HP']) / 1000]
]

# Data for consumed energy
data_consumed = [
    ["Phase A Consumed Off-Peak", current_consumed_energy_Wh['phase_a']['HC'], simulated_consumed_energy_Wh['phase_a']['HC'], simulated_consumed_energy_Wh['phase_a']['HC'] - current_consumed_energy_Wh['phase_a']['HC'], get_current_tariff_price("HC", "consume") * abs(simulated_consumed_energy_Wh['phase_a']['HC'] - current_consumed_energy_Wh['phase_a']['HC']) / 1000],
    ["Phase A Consumed Peak", current_consumed_energy_Wh['phase_a']['HP'], simulated_consumed_energy_Wh['phase_a']['HP'], simulated_consumed_energy_Wh['phase_a']['HP'] - current_consumed_energy_Wh['phase_a']['HP'], get_current_tariff_price("HP", "consume") * abs(simulated_consumed_energy_Wh['phase_a']['HP'] - current_consumed_energy_Wh['phase_a']['HP']) / 1000],
    ["Phase B Consumed Off-Peak", current_consumed_energy_Wh['phase_b']['HC'], simulated_consumed_energy_Wh['phase_b']['HC'], simulated_consumed_energy_Wh['phase_b']['HC'] - current_consumed_energy_Wh['phase_b']['HC'], get_current_tariff_price("HC", "consume") * abs(simulated_consumed_energy_Wh['phase_b']['HC'] - current_consumed_energy_Wh['phase_b']['HC']) / 1000],
    ["Phase B Consumed Peak", current_consumed_energy_Wh['phase_b']['HP'], simulated_consumed_energy_Wh['phase_b']['HP'], simulated_consumed_energy_Wh['phase_b']['HP'] - current_consumed_energy_Wh['phase_b']['HP'], get_current_tariff_price("HP", "consume") * abs(simulated_consumed_energy_Wh['phase_b']['HP'] - current_consumed_energy_Wh['phase_b']['HP']) / 1000],
    ["Phase C Consumed Off-Peak", current_consumed_energy_Wh['phase_c']['HC'], simulated_consumed_energy_Wh['phase_c']['HC'], simulated_consumed_energy_Wh['phase_c']['HC'] - current_consumed_energy_Wh['phase_c']['HC'], get_current_tariff_price("HC", "consume") * abs(simulated_consumed_energy_Wh['phase_c']['HC'] - current_consumed_energy_Wh['phase_c']['HC']) / 1000],
    ["Phase C Consumed Peak", current_consumed_energy_Wh['phase_c']['HP'], simulated_consumed_energy_Wh['phase_c']['HP'], simulated_consumed_energy_Wh['phase_c']['HP'] - current_consumed_energy_Wh['phase_c']['HP'], get_current_tariff_price("HP", "consume") * abs(simulated_consumed_energy_Wh['phase_c']['HP'] - current_consumed_energy_Wh['phase_c']['HP']) / 1000]
]
